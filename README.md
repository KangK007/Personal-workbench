...
个人工作台 0.1 是一款面向科研学习与个人项目的本地优先 Flutter 应用。它把“快速收集、项目规划、安排今天、专注执行、知识沉淀、回顾、目标与行为追踪”放在一条可验证的工作流中，并融合了 SelfControl 的 Windows 自律限制能力。本轮界面采用“刻度日志”视觉体系：以日期刻度、状态字、时间轴和证据记录组织页面，适合长期使用，不把科研工作包装成游戏化仪表盘。
